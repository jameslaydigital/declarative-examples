...
/// EXAMPLE CODE ///
//window.root = new E2.RootWrapper(
//    new E2("div", {},
//        new E2("text", {"static":{
//            "nodeValue": "welcome!"
//        }}),
...
//        }}),
//        new E2("ul", {},
//            new E2.ForEach(() => model.users, (i0) =>
//                new E2("li", {},
//                    new E2("span", {dynamic: {
//                        innerHTML: () => model.users[i0].username
//                    }}),
//                    new E2.ForEach(() => model.users[i0].departments, (i1) =>
//                        new E2("span", {},
//                            new E2("text", {dynamic:{nodeValue: () => {
